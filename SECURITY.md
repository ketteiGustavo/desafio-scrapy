...
1. **E-mail (recomendado):** envie um relatório para **neste e-mail: <luizgcesar@gmail.com>** com o máximo de informações possível (passos para reprodução, impacto, versão/commit afetado, sistema operacional).
